"use strict";
(self["webpackChunkfiddle"] = self["webpackChunkfiddle"] || []).push([["node_modules_codemirror_lang-go_dist_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _lezer_go__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lezer/go */ 4022);
...
*/
const snippets = [/*@__PURE__*/(0,_codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_2__.snippetCompletion)("func ${name}(${params}) ${type} {\n\t${}\n}", {
  label: "func",
  detail: "declaration",
  type: "keyword"
...
const goLanguage = /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.LRLanguage.define({
  ...
  parser: /*@__PURE__*/_lezer_go__WEBPACK_IMPORTED_MODULE_0__.parser.configure({
    props: [/*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.indentNodeProp.add({
      ...
      BlockComment: () => null,
      Statement: /*@__PURE__*/(0,_codemirror_language__WEBPACK_IMPORTED_MODULE_3__.continuedIndent)({
        except: /^{/
      })
...
function go() {
  ...
  return new _codemirror_language__WEBPACK_IMPORTED_MODULE_3__.LanguageSupport(goLanguage, [goLanguage.data.of({
...
//# sourceMappingURL=node_modules_codemirror_lang-go_dist_index_js.js.map