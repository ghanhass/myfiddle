"use strict";
(self["webpackChunkfiddle"] = self["webpackChunkfiddle"] || []).push([["node_modules_codemirror_lang-vue_dist_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @codemirror/language */ 3308);
/* harmony import */ var _codemirror_lang_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @codemirror/lang-html */ 198);
/* harmony import */ var _codemirror_lang_javascript__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @codemirror/lang-javascript */ 1252);
/* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lezer/highlight */ 3798);
/* harmony import */ var _lezer_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @lezer/common */ 4855);
/* harmony import */ var _lezer_lr__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @lezer/lr */ 3378);
...
const baseParser = /*@__PURE__*/parser.configure({
  props: [/*@__PURE__*/(0,_lezer_highlight__WEBPACK_IMPORTED_MODULE_0__.styleTags)({
...
function vue(config = {}) {
  let base = baseHTML;
  if (config.base) {
    if (config.base.language.name != "html" || !(config.base.language instanceof _codemirror_language__WEBPACK_IMPORTED_MODULE_5__.LRLanguage)) throw new RangeError("The base option must be the result of calling html(...)");
    base = config.base;
  }
  return new _codemirror_language__WEBPACK_IMPORTED_MODULE_5__.LanguageSupport(base.language == baseHTML.language ? vueLanguage : makeVue(base.language), [base.support, base.language.data.of({
    closeBrackets: {
      brackets: ["{", '"']
    }
  })]);
...
//# sourceMappingURL=node_modules_codemirror_lang-vue_dist_index_js.js.map