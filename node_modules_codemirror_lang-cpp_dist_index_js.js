"use strict";
(self["webpackChunkfiddle"] = self["webpackChunkfiddle"] || []).push([["node_modules_codemirror_lang-cpp_dist_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _lezer_cpp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lezer/cpp */ 4293);
...
const cppLanguage = /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.LRLanguage.define({
  ...
  parser: /*@__PURE__*/_lezer_cpp__WEBPACK_IMPORTED_MODULE_0__.parser.configure({
    props: [/*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.indentNodeProp.add({
      IfStatement: /*@__PURE__*/(0,_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.continuedIndent)({
        except: /^\s*({|else\b)/
      }),
      TryStatement: /*@__PURE__*/(0,_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.continuedIndent)({
        except: /^\s*({|catch)\b/
      }),
      LabeledStatement: _codemirror_language__WEBPACK_IMPORTED_MODULE_1__.flatIndent,
      CaseStatement: context => context.baseIndent + context.unit,
      BlockComment: () => null,
      CompoundStatement: /*@__PURE__*/(0,_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.delimitedIndent)({
        closing: "}"
      }),
      Statement: /*@__PURE__*/(0,_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.continuedIndent)({
        except: /^{/
      })
...
const fallback = new _lezer_lr__WEBPACK_IMPORTED_MODULE_0__.ExternalTokenizer(input => {
  if (input.next == GreaterThan) {
    ...
    let sawLetter = false,
      i = 0;
    for (;; i++) {
      if (input.next >= A && input.next <= Z) sawLetter = true;else if (input.next >= a && input.next <= z) return;else if (input.next != Underscore && !(input.next >= Zero && input.next <= Zero + 9)) break;
      input.advance();
    }
...
const parser = _lezer_lr__WEBPACK_IMPORTED_MODULE_0__.LRParser.deserialize({
  ...
  maxTerm: 425,
  nodeProps: [["group", -35, 1, 8, 11, 15, 16, 17, 19, 71, 72, 100, 101, 102, 104, 191, 208, 229, 242, 243, 270, 271, 272, 277, 280, 281, 282, 284, 285, 286, 287, 290, 292, 293, 294, 295, 296, "Expression", -13, 18, 25, 26, 27, 43, 255, 256, 257, 258, 262, 263, 265, 266, "Type", -19, 126, 129, 147, 150, 152, 153, 158, 160, 163, 164, 166, 168, 170, 172, 174, 176, 178, 179, 188, "Statement"], ["isolate", -4, 4, 5, 8, 10, ""], ["openedBy", 12, "(", 52, "{", 54, "["], ["closedBy", 13, ")", 51, "}", 53, "]"]],
...
//# sourceMappingURL=node_modules_codemirror_lang-cpp_dist_index_js.js.map