"use strict";
(self["webpackChunkfiddle"] = self["webpackChunkfiddle"] || []).push([["node_modules_codemirror_lang-markdown_dist_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _codemirror_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @codemirror/state */ 6151);
/* harmony import */ var _codemirror_view__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @codemirror/view */ 8905);
/* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @codemirror/language */ 3308);
/* harmony import */ var _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @codemirror/autocomplete */ 8990);
/* harmony import */ var _lezer_markdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lezer/markdown */ 8939);
/* harmony import */ var _codemirror_lang_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @codemirror/lang-html */ 198);
/* harmony import */ var _lezer_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @lezer/common */ 4855);
...
const data = /*@__PURE__*/(0,_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.defineLanguageFacet)({
  commentTokens: {
    block: {
      open: "<!--",
      close: "-->"
...
const commonmark = /*@__PURE__*/_lezer_markdown__WEBPACK_IMPORTED_MODULE_0__.parser.configure({
  props: [/*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.foldNodeProp.add(type => {
    return !type.is("Block") || type.is("Document") || isHeading(type) != null || isList(type) ? undefined : (tree, state) => ({
      from: state.doc.lineAt(tree.from).to,
      to: tree.to
    });
  }), /*@__PURE__*/headingProp.add(isHeading), /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.indentNodeProp.add({
    Document: () => null
...
const extended = /*@__PURE__*/commonmark.configure([_lezer_markdown__WEBPACK_IMPORTED_MODULE_0__.GFM, _lezer_markdown__WEBPACK_IMPORTED_MODULE_0__.Subscript, _lezer_markdown__WEBPACK_IMPORTED_MODULE_0__.Superscript, _lezer_markdown__WEBPACK_IMPORTED_MODULE_0__.Emoji, {
  props: [/*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.foldNodeProp.add({
    Table: (tree, state) => ({
      from: state.doc.lineAt(tree.from).to,
      to: tree.to
    })
...
function getCodeParser(languages, defaultLanguage) {
  return info => {
    if (info && languages) {
      ...
      info = /\S*/.exec(info)[0];
      if (typeof languages == "function") found = languages(info);else found = _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.LanguageDescription.matchLanguageName(languages, info, true);
      if (found instanceof _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.LanguageDescription) return found.support ? found.support.language.parser : _codemirror_language__WEBPACK_IMPORTED_MODULE_2__.ParseContext.getSkippingParser(found.load());else if (found) return found.parser;
    }
...
function normalizeIndent(content, state) {
  ...
  if (!blank || state.facet(_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.indentUnit) != "\t") return content;
    ...
    changes = state.changeByRange(range => {
      ...
      if (inner.item && emptyLine) {
        ...
        if (first.to >= pos || second && second.to < pos || line.from > 0 && !/[^\s>]/.test(doc.lineAt(line.from - 1).text)) {
          ...
          return {
            range: _codemirror_state__WEBPACK_IMPORTED_MODULE_3__.EditorSelection.cursor(delTo + insert.length),
            changes
          };
        } else {
          ...
          return {
            range: _codemirror_state__WEBPACK_IMPORTED_MODULE_3__.EditorSelection.cursor(pos + insert.length + 1),
            changes: {
              from: line.from,
      ...
      if (!continued || /^[\s\d.)\-+*>]*/.exec(line.text)[0].length >= inner.to) {
        for (let i = 0, e = context.length - 1; i <= e; i++) {
          insert += i == e && !continued ? context[i].marker(doc, 1) : context[i].blank(i < e ? (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_3__.countColumn)(line.text, 4, context[i + 1].from) - insert.length : null);
        }
      }
      let from = pos;
      ...
      return {
        range: _codemirror_state__WEBPACK_IMPORTED_MODULE_3__.EditorSelection.cursor(from + insert.length + 1),
        changes
      };
    });
      ...
      if (range.empty && markdownLanguage.isActiveAt(state, range.from)) {
        ...
        if (context.length) {
          ...
          if (pos - line.from > spaceEnd && !/\S/.test(line.text.slice(spaceEnd, pos - line.from))) return {
            range: _codemirror_state__WEBPACK_IMPORTED_MODULE_3__.EditorSelection.cursor(line.from + spaceEnd),
            changes: {
          ...
          !inner.item || line.from <= inner.item.from || !/\S/.test(line.text.slice(0, inner.to)))) {
            ...
            if (inner.item && inner.node.from < inner.item.from && /\S/.test(line.text.slice(inner.from, inner.to))) {
              ...
              return {
                range: _codemirror_state__WEBPACK_IMPORTED_MODULE_3__.EditorSelection.cursor(start + insert.length),
                changes: {
                  from: start,
            ...
            if (start < pos) return {
              range: _codemirror_state__WEBPACK_IMPORTED_MODULE_3__.EditorSelection.cursor(start),
              changes: {
                from: start,
                to: pos
              }
...
const htmlNoMatch = /*@__PURE__*/(0,_codemirror_lang_html__WEBPACK_IMPORTED_MODULE_4__.html)({
...
function markdown(config = {}) {
  ...
  if (!(parser instanceof _lezer_markdown__WEBPACK_IMPORTED_MODULE_0__.MarkdownParser)) throw new RangeError("Base parser provided to `markdown` should be a Markdown parser");
  ...
  extensions.push((0,_lezer_markdown__WEBPACK_IMPORTED_MODULE_0__.parseCode)({
    codeParser,
    htmlParser: htmlTagLanguage.language.parser
  }));
  if (addKeymap) support.push(_codemirror_state__WEBPACK_IMPORTED_MODULE_3__.Prec.high(_codemirror_view__WEBPACK_IMPORTED_MODULE_5__.keymap.of(markdownKeymap)));
...
function htmlTagCompletions() {
  ...
  let result = (0,_codemirror_lang_html__WEBPACK_IMPORTED_MODULE_4__.htmlCompletionSource)(new _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_6__.CompletionContext(_codemirror_state__WEBPACK_IMPORTED_MODULE_3__.EditorState.create({
...
/* harmony export */ });
/* harmony import */ var _lezer_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lezer/common */ 4855);
/* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @lezer/highlight */ 3798);
...
class CompositeBlock {
  ...
  addChild(child, pos) {
    if (child.prop(_lezer_common__WEBPACK_IMPORTED_MODULE_0__.NodeProp.contextHash) != this.hash) child = new _lezer_common__WEBPACK_IMPORTED_MODULE_0__.Tree(child.type, child.children, child.positions, child.length, this.hashProp);
...
class BlockContext {
  ...
  */
  addNode(block, from, to) {
    if (typeof block == "number") block = new _lezer_common__WEBPACK_IMPORTED_MODULE_0__.Tree(this.parser.nodeSet.types[block], none, none, (to !== null && to !== void 0 ? to : this.prevLineEnd()) - from);
  ...
  configure(spec) {
    ...
    if (nonEmpty(config.defineNodes)) {
      ...
      for (let s of config.defineNodes) {
        ...
        if (style) {
          if (!styles) styles = {};
          if (Array.isArray(style) || style instanceof _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.Tag) styles[name] = style;else Object.assign(styles, style);
        }
      }
      nodeSet = new _lezer_common__WEBPACK_IMPORTED_MODULE_0__.NodeSet(nodeTypes);
      if (styles) nodeSet = nodeSet.extend((0,_lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.styleTags)(styles));
    }
...
const Strikethrough = {
  defineNodes: [{
    name: "Strikethrough",
    style: {
      "Strikethrough/...": _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.strikethrough
    }
  }, {
...
const Table = {
  defineNodes: [{
    ...
    name: "TableHeader",
    style: {
      "TableHeader/...": _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.heading
    }
  }, "TableRow", {
    name: "TableCell",
    style: _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.content
  }, {
    name: "TableDelimiter",
    style: _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.processingInstruction
  }],
...
const TaskList = {
  defineNodes: [{
    name: "Task",
    block: true,
    style: _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.list
  }, {
    name: "TaskMarker",
    style: _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.atom
  }],
  parseBlock: [{
    name: "TaskList",
    leaf(cx, leaf) {
...
const Superscript = {
  defineNodes: [{
    name: "Superscript",
    style: _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.special(_lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.content)
  }, {
...
const Emoji = {
  defineNodes: [{
    name: "Emoji",
    style: _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.character
  }],
  parseInline: [{
    name: "Emoji",
    parse(cx, next, pos) {
...
//# sourceMappingURL=node_modules_codemirror_lang-markdown_dist_index_js.js.map