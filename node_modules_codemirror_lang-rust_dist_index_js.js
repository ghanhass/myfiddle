"use strict";
(self["webpackChunkfiddle"] = self["webpackChunkfiddle"] || []).push([["node_modules_codemirror_lang-rust_dist_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _lezer_rust__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lezer/rust */ 6538);
...
const rustLanguage = /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.LRLanguage.define({
  ...
  parser: /*@__PURE__*/_lezer_rust__WEBPACK_IMPORTED_MODULE_0__.parser.configure({
    props: [/*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.indentNodeProp.add({
      IfExpression: /*@__PURE__*/(0,_codemirror_language__WEBPACK_IMPORTED_MODULE_1__.continuedIndent)({
        except: /^\s*({|else\b)/
      }),
      ...
      if (/(Block|edTokens|List)$/.test(type.name)) return _codemirror_language__WEBPACK_IMPORTED_MODULE_1__.foldInside;
...
const tpDelim = new _lezer_lr__WEBPACK_IMPORTED_MODULE_0__.ExternalTokenizer(input => {
  if (input.next == LessThan) input.acceptToken(tpOpen, 1);else if (input.next == GreaterThan) input.acceptToken(tpClose, 1);
});
...
//# sourceMappingURL=node_modules_codemirror_lang-rust_dist_index_js.js.map