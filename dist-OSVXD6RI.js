import {
  completeFromList,
  ifNotIn
} from "./chunk-RMC3D5Y5.js";
import {
  ExternalTokenizer,
  LRParser
} from "./chunk-LDOLUMKA.js";
import {
  LRLanguage,
  LanguageSupport,
  continuedIndent,
...
function maybeQuoteCompletions(quote, completions) {
  if (!quote)
    return completions;
  return completions.map((c) => __spreadProps(__spreadValues({}, c), { label: c.label[0] == quote ? c.label : quote + c.label + quote, apply: void 0 }));
}
var Span = /^\w*$/;
var QuotedSpan = /^[`'"]?\w*[`'"]?$/;
...
//# sourceMappingURL=dist-OSVXD6RI.js.map
